...
|---|---|---|
| `pathmemo-win-x64.exe` | **16–30 МБ** | основной. Измерено: 16.1 МБ на P0-скелете (77.3 МБ без trimming), 19.5 МБ на P3, **22.5 МБ на P4** — плюс 3 МБ дал `Microsoft.Data.Sqlite` с нативным `e_sqlite3`. |
